#model 7 is used for trial Conv2dRep
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for imagePath, measurement in batch_samples:
                ...
                combined_image = cv2.resize(combined_image, (320, 240), fx=0.5, fy=0.5)
...
if __name__ == '__main__':
    ...
    if trainFolder != None:
        ...
        lr_find = LRFind(1e-6, 1e1, lr_finder_steps)
        callbacks = [EarlyStopping(monitor='val_loss', patience=3),
            ModelCheckpoint(filepath='best'+MODEL_NAME+'.h5', monitor='loss', save_best_only=True)]
        # callbacks = [ModelCheckpoint(filepath='tmp/weights{epoch:02d}'+ MODEL_NAME+'.h5', monitor='val_loss', save_best_only=False)]
